...
**â™¦ Framing the Business Scenario**

**â™¦ Choosing the Right Visuals**

**â™¦ Creating Effective Visuals**

**â™¦ Communicating Insights and Analysis**
...
Youâ€™ve been provided a dataset in the resources below to use as the basis for your exploration. Review this data, taking note of what information has been provided, what insights you can garner, and what is relevant to both the CEO and CMO respectively.
...
â€¢ Create a check that the quantity should not be below 1 unit

â€¢ Create a check that the Unit price should not be below $0
...
Itâ€™s time to present your findings to the CEO and CMO. They are interested in your thought process and how you have handled the data cleanup and visualisation phase. It is important to explain your thought process and ideas in a clear and straightforward way. You are also required to clearly present the analysis of all four questions from the previous task. Make sure you are well versed with the data and the conclusions youâ€™ve made from your analysis. 

Expansion is top of mind for these leaders and theyâ€™re keen to understand where the most lucrative opportunities are in their business.
...
When writing your script, you should speak about your entire process, including the initial data load and clean-up steps so that your leaders know youâ€™ve done your due diligence in providing error-free analysis. 
...
Remember, this is not just a read out of your visuals, youâ€™re presenting to the CEO and CMO and need to provide context for each scenario and how it relates to their questioning.
